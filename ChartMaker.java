...
public class ChartMaker extends AndroidNonvisibleComponent implements Component {
    ...
    private static String PrepareLineLabels(YailList labelInput){
        ...
        parsedLabels.append("data.addColumn('timeofday', 'X');");
    ...
    public void DrawLineGraph(String chartTitle,String Color, String hAxisTitle, String vAxisTitle, YailList labels, YailList values, WebViewer webViewer){
        ...
        try {
            String htmlCode = "<html>\n" +
                  ...
                  "    <script type=\"text/javascript\" src=\"loader.js\"></script>\n" +
                    ...
                    "legend: { textStyle:{color: 'white'},position: 'top' },\n" +  /**Added by Xelibix**/
					"explorer: { axis: 'vertical' },\n" +   /**not supported yet on phone**/
					" backgroundColor:'black',\n" +
					" chartArea:{left:45,right:5,top:20,bottom:45,width:'100%',height:'100%'},\n" +
					"colors:["+ Color + "],\n" +
                    "width: 360,\n" +
                    "height: 560,\n" +
                    "hAxis: {" +
                    "   title: '" + hAxisTitle + "',minorGridlines:{color: 'white'},titleTextStyle:{color: 'white'},textStyle:{color: 'white'}, baselineColor: 'white',gridlineColor: 'white',\n" +
                    "                       },\n" +
                    "vAxis: {" +
                    "   title: '" + vAxisTitle + "', minorGridlines:{color: 'white'},titleTextStyle:{color: 'white'},textStyle:{color: 'white'}, baselineColor: 'white',gridlineColor: 'white',\n" +
                    "                       }" +
                    "};\n" +
                    "\n" +
                    ...
                    "  </body>\n" +
                    "</html>";
            File file = new File("/sdcard/AppInventor/Final.html");
            filePath = file.getAbsolutePath();
            FileWriter filewriter = new FileWriter(file);
            filewriter.write(htmlCode);
            filewriter.close();
